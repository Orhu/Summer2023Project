...
using UnityEngine.SceneManagement;
    ...
    public sealed class TrailElement: MonoBehaviour {
		...
		public GameObject m_GameObjectTrail;
        ...
        public static void RefreshFreeElements() {
            ...
            foreach (var e in m_FreeElements) {
                ...
                if (e != null && e.m_GameObjectTrail.scene.IsValid() && e.m_GameObjectTrail.scene.isLoaded) {
        ...
        public void Initialise(SpriteTrail trail) {
            ...
            m_MotherTrail = trail;
            this.m_GameObjectTrail.SetActive(true);
        ...
        public void Hide(bool AddToFree = true) {
            if (m_GameObjectTrail == null || this == null)
                return;
            ...
            this.m_GameObjectTrail.SetActive(false);
            if (AddToFree) {
